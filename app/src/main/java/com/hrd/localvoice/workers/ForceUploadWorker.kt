        ...
        audios?.forEach { audio ->
            ...
            if (audio.localFileURl.split(".wav").size > 1) {
                ...
                if (file.exists() && (participant == null || participant.momoNumber != null)) {
                    ...
                    val reUpload = MultipartBody.Part.createFormData(
                        "re_upload", null, RequestBody.create(
                    ...
                    Log.d(tag, "forceUploadUploadedAudios: file not found")
                }
            }
        }
    }
